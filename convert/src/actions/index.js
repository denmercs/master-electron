...
export const addVideos = (videos) => (dispatch) => {
  ...
  ipcRenderer.on("metadataComplete", (event, videosWithData) => {
...
export const convertVideos = (videos) => (dispatch) => {
  ipcRenderer.send("conversionStart", videos);
  ipcRenderer.on("conversionEnd", (e, { video, outputPath }) => {
    dispatch({ type: VIDEO_COMPLETE, payload: { ...video, outputPath } });
  });
  ipcRenderer.on("conversionProgress", (e, { video, timemark }) => {
